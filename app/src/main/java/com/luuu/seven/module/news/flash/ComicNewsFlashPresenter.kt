 ...
 *
 */
class ComicNewsFlashPresenter(var mView: ComicNewsFlashContract.View) : ComicNewsFlashContract.Presenter {
    ...
    override fun getComicData(page: Int) {
        mSubscriptions.add(TaskData.getComicNewsFlash(page).subscribe({
            t ->
