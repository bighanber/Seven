...
fun RecyclerView.ViewHolder.string(@StringRes id: Int, vararg str: String?) = itemView.string(id, *str)
fun RecyclerView.ViewHolder.stringArr(@ArrayRes id: Int) = itemView.stringArr(id)
